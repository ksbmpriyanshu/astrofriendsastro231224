...
// console.log(" providerData?.call_status", providerData)
      ...
      <View style={{ flex: 0, padding: 10, paddingVertical: 2, }}>
        ...
        <View
          ...
          <TouchableOpacity onPress={() => navigation.navigate('language')} >
              <FontAwesome name="language" size={35} style={{ color: '#FE6006' }} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('Notifications')} >
              <Feather name="bell" size={35} style={{ color: '#FE6006' }} />
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.openDrawer()} >
              <Feather name="menu" size={35} style={{ color: '#FE6006' }} />
            </TouchableOpacity>
          </View>
        </View>
          ...
          <View style={{ paddingHorizontal: 15 }}>
            ...
            <TouchableOpacity
              ...
              style={{
                ...styles.boxContainerA,
                width: '100%',
                backgroundColor: providerData?.nextOnline?.date ? colors.green_color2 : "#FE6006",
              }}>
              {/* <FontAwesome
                name="phone"
                color={colors.white_color}
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                justifyContent: 'space-between',
                alignItems: 'center',
                backgroundColor: "#FE600647",
                borderWidth: 1,
                borderColor: "#FE600647",
                marginTop: 15,
                borderRadius: 5,
