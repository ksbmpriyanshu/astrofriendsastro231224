  ...
  try {
    return ZegoUIKitPrebuiltCallService.init(
      ...
      [ZIM, ZPNs],
      {
        ...
        requireConfig: data => {
          console.log('Call Config Data:', data);
          const callConfig =
            data.invitees.length > 1
              ...
              : ZegoInvitationType.videoCall === data.type
                ? ONE_ON_ONE_VIDEO_CALL_CONFIG
                : ONE_ON_ONE_VOICE_CALL_CONFIG;
          console.log('Generated Call Config:', callConfig);
          return {
            callConfig,
            topMenuBarConfig: {
              buttons: [
            ...
            onWindowMinimized: () => {
              console.log("Window Minimized Clicked!")
            //  navigate('providerHome')
            //   console.log("Minimized State Triggered");

            },
            onWindowMaximized: () => {
              console.log("Window Maximized Clicked!")
